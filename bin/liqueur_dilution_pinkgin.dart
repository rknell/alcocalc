...
const double startingABV = 0.526;
const double startingTemperature = 24.9;
const double startingWeight = 34.2;

final sugars = <Sugars>[
  Sugars(name: 'Strawberry Syrup', specificGravity: 1.247, percentage: .15),
];
