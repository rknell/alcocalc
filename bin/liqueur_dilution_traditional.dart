...
const double startingABV = 0.522;
const double startingTemperature = 26.4;
const double startingWeight = 61.74;

final sugars = <Sugars>[
  Sugars(name: 'Sugar Syrup', specificGravity: 1.51257, percentage: .01),
];

//2 to 1 sugar syrup weight recipe
// 1.581kg sugar to 1kg water
